...
curated_customers_df = curated_customers.toDF().dropDuplicates(["email"])
curated_customers = DynamicFrame.fromDF(curated_customers_df, glueContext, "curated_customers")

# 5. Write output to curated/customers/
glueContext.write_dynamic_frame.from_options(
    frame=curated_customers,
    connection_type="s3",
    format="json",
    connection_options={"path": "s3://stedi-project-userthompson/curated/customers/"}
)
